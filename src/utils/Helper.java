...
public class Helper {
	...
	public static final String GET_ALL_ROOMS = "SELECT * FROM " + TABLE_ROOMS ;
	...
	public static final String GET_ALL_BOOKING_INFO = "SELECT * FROM " + TABLE_BOOKINGS ;
	...
	public static final String GET_ALL_CUSTOMER_INFO = "SELECT * FROM " + TABLE_CUSTOMERS ;
	...
	public static final String VALIDATE_USER = "SELECT * FROM " + TABLE_USERS + " WHERE username = ? AND password = ?";
	public static final String GET_ALL_USERS = "SELECT * FROM " + TABLE_USERS ;
	public static final String REGISTER_USER = "INSERT INTO " + TABLE_USERS + "(username, password, email, role) VALUES (?,?,?,?)";
	
	public static final String INSERT_PAYMENT = "INSERT INTO " + TABLE_PAYMENTS + " (userid, roomid, amount) VALUES (?,?,?)";
