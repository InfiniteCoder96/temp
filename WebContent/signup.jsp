	...
	<div id="error" class="alert alert-danger" role="alert" style="display:none"></div>
			<div class="row" >
				<div class="col-lg-12 p-b-30">
					...
					<form class="wrap-form-reservation size22 m-l-r-auto" method="post" action="user_controller" id="signup-form">
					...
					<c:if test="${not empty INVALID_USER}">
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="wrap-inputdate pos-relative txt10 size12 bo2 bo-rad-10 m-t-3 m-b-23">
									<input class="bo-rad-10 sizefull  p-l-20" type="email"  name="email" id="email"/>
					...
					<div class="wrap-btn-booking flex-c-m m-t-6" style="margin-top:30px">
							...
							<a href="login.jsp"><button type="submit" class="btn3 flex-c-m size13 txt11 trans-0-4">
								Sign In
							</button></a>
					</div>
	...
	$('#username').on('change',function () {    
		...
		if(username == ""){
			...
			if(username.length <= 5){
				document.getElementById("error_username").innerHTML = "Username must contain minimum 5 characters";
				errors = true;
			}
			else{
	...
	$('#password').on('change',function () {    
		...
		if(password == ""){
			...
			if(password.length <= 5){
				document.getElementById("error_password").innerHTML = "Password must contain minimum 5 characters";
				errors = true;
			}
			else{
