				...
				<div class="item-slick1 item1-slick1" style="background-image: url(images/master-slides-01.jpg);">
					<div class="wrap-content-slide1 sizefull flex-col-c-m p-l-15 p-r-15 p-t-150 p-b-170">
						...
						<div class="wrap-btn-slide1 animated visible-false" data-appear="zoomIn">
							<!-- Button1 -->
							<a href="menu.html" class="btn1 flex-c-m size1 txt3 trans-0-4 bg-danger text-white">
								Look Menu
							</a>
						</div>
					</div>
			...
			<div class="container">
				<div class="flex-sb-m flex-w p-t-22 p-b-22">
					...
					<div class="txt17 p-r-20 p-t-5 p-b-5">
						Copyright &copy; 2019 All rights reserved  |  Made with <i class="fa fa-heart"></i> by <a href="https://inofinitylabs.com" target="_blank">Inofinitylabs</a>
					</div>
				</div>
			</div>
		</div>
